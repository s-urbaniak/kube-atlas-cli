...
//go:generate mockgen -destination=../../../mocks/mock_atlas_operator_crd_provider.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/kubernetes/operator/crds AtlasOperatorCRDProvider
