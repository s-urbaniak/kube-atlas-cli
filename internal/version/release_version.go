...
//go:generate mockgen -destination=../mocks/mock_release_version.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/version ReleaseVersionDescriber
