...
//go:generate mockgen -destination=../mocks/mock_default_mongodb_version.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store DefaultVersionGetter
