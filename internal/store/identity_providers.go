...
//go:generate mockgen -destination=../mocks/mock_identity_providers_store.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store IdentityProviderLister,IdentityProviderDescriber,IdentityProviderCreator,IdentityProviderDeleter,IdentityProviderUpdater,IdentityProviderJwkRevoker
