...
//go:generate mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store AuditingDescriber,AuditingUpdater
