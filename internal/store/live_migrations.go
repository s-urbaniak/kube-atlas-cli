...
//go:generate mockgen -destination=../mocks/mock_live_migrations.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store LiveMigrationCreator,LiveMigrationDescriber
