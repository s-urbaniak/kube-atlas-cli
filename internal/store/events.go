...
//go:generate mockgen -destination=../mocks/mock_events.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store OrganizationEventLister,ProjectEventLister,EventLister
