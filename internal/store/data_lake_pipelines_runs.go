...
//go:generate mockgen -destination=../mocks/mock_data_lake_pipelines_runs.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store PipelineRunsLister,PipelineRunsDescriber
