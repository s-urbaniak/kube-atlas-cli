...
//go:generate mockgen -destination=../mocks/mock_processes.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store ProcessLister,ProcessDescriber
