...
//go:generate mockgen -destination=../mocks/mock_federation_settings_store.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store FederationSettingsDescriber
