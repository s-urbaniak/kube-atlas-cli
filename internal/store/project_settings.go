...
//go:generate mockgen -destination=../mocks/mock_project_settings.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store ProjectSettingsDescriber,ProjectSettingsUpdater
