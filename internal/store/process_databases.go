...
//go:generate mockgen -destination=../mocks/mock_process_databases.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store ProcessDatabaseLister
