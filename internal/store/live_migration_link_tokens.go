...
//go:generate mockgen -destination=../mocks/mock_live_migration_link_tokens.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store LinkTokenCreator,LinkTokenDeleter
