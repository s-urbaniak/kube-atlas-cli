...
//go:generate mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store AlertDescriber,AlertLister,AlertAcknowledger
