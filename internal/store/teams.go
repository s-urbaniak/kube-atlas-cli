...
//go:generate mockgen -destination=../mocks/mock_teams.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store TeamLister,TeamDescriber,TeamCreator,TeamRenamer,TeamDeleter,TeamAdder,TeamUserRemover,TeamRolesUpdater
