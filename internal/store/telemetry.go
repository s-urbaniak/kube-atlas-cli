...
//go:generate mockgen -destination=../mocks/mock_telemetry.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store EventsSender,UnauthEventsSender
