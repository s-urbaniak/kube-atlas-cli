...
//go:generate mockgen  -destination=../mocks/mock_process_disk_measurements.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store ProcessDiskMeasurementsLister,ProcessDatabaseMeasurementsLister
