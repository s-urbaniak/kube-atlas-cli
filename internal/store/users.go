...
//go:generate mockgen -destination=../mocks/mock_users.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store UserCreator,UserDescriber,UserLister,TeamUserLister
