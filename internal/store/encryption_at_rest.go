...
//go:generate mockgen -destination=../mocks/mock_encryption_at_rest.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store EncryptionAtRestDescriber
