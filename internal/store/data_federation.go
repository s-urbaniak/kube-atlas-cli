...
//go:generate mockgen -destination=../mocks/mock_data_federation.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store DataFederationLister,DataFederationDescriber,DataFederationStore,DataFederationCreator,DataFederationUpdater,DataFederationDeleter,DataFederationLogDownloader
