...
//go:generate mockgen -destination=../mocks/mock_cloud_provider_regions.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store CloudProviderRegionsLister
