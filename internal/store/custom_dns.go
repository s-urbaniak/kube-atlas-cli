...
//go:generate mockgen -destination=../mocks/mock_custom_dns.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/store CustomDNSEnabler,CustomDNSDisabler,CustomDNSDescriber
