...
import (
	...
	"github.com/s-urbaniak/kube-atlas-cli/internal/version"
	"github.com/spf13/afero"
	"github.com/spf13/viper"
	"go.mongodb.org/atlas/auth"
)

//go:generate mockgen -destination=../mocks/mock_profile.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/config SetSaver
