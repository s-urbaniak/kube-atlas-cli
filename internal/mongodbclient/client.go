...
//go:generate mockgen -destination=../mocks/mock_mongodb_client.go -package=mocks github.com/s-urbaniak/kube-atlas-cli/internal/mongodbclient MongoDBClient,Database,SearchIndex
